...
PalPacket_Titlescreen:    PAL_SET PAL_LOGO2, PAL_LOGO1, PAL_REDMON, PAL_PURPLEMON
PalPacket_TrainerCard:    PAL_SET PAL_REDMON, PAL_BADGE, PAL_REDMON, PAL_YELLOWMON
PalPacket_Generic:        PAL_SET PAL_REDMON, 0, 0, 0
